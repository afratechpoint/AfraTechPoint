...
export default function Home() {
  ...
  const rawBanners = settings.banners && settings.banners.length > 0 ? settings.banners : [
    { title: "Sequoia Inspiring Musico.", subtitle: "Music Is Classic", imageUrl: "/images/blue_headphones.png" },
    { title: "New Gen X-Bud.", subtitle: "Clear Sounds", imageUrl: "/images/white_earbuds.png" },
    { title: "Surface VR Headset.", subtitle: "Advanced VR", imageUrl: "/images/vr_headset.png" }
  ];
