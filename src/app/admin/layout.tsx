...
export default function AdminLayout({
  ...
  // ── PWA: Swap manifest to admin-specific one ──────────────────────────
  useEffect(() => {
    ...
    if (appName) appName.content = "Afra Admin";

    return () => {
      // Restore shop manifest when navigating away from admin
      if (manifestLink) manifestLink.href = "/manifest.webmanifest";
      if (themeColor) themeColor.content = "#111111";
      if (appName) appName.content = "Afra Tech Point";
    };
  }, []);
