...
import { Search, ShoppingCart, Filter, ArrowRight, X } from "lucide-react";
  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-white">
      ...
      <div className="w-full max-w-[1440px] mx-auto flex flex-col relative px-4 md:px-8">
        ...
        <div className="flex flex-col gap-4 mt-2 md:mt-4 mb-20 relative w-full">
                        ...
                        <div className="space-y-1.5 flex flex-col flex-1 px-1">
                           <div className="flex justify-between items-center">
                            ...
                            <div className="flex flex-col items-end">
                               {product.salePrice && (
                                 <span className="text-[10px] font-black text-gray-300 line-through tracking-tighter mb-0.5">
